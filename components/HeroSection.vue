    ...
    <div id="home" class="mt-12 overflow-hidden min-h-screen flex xl:mt-10 justify-evenly items-center flex-col-reverse text-center md:flex-row">
      <div>
        ...
        <div class="flex justify-left mt-3">
          <a
          href="https://tbooking.toubiz.de/DEU00000060013432410/tbooking/?globalReset=1&lang=de"
          class="md:m-0 m-auto px-3 py-3 md:px-7 md:py-4 text-sm md:text-lg bg-[#700303] text-white font-raleway"
